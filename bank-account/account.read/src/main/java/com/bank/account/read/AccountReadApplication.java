package com.bank.account.read;

import com.bank.account.read.api.queries.*;
...
public class AccountReadApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(AccountReadApplication.class, args);
	}
